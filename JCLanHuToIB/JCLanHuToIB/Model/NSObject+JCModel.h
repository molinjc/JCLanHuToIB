 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `JCModel` protocol for custom methods.
 ...
 ********************** json convertor *********************
 @code
 @interface JCAuthor : NSObject
 @property (nonatomic, strong) NSString *name;
 @property (nonatomic, assign) NSDate *birthday;
 @end
 @implementation JCAuthor
 @end
 
 @interface JCBook : NSObject
 @property (nonatomic, copy) NSString *name;
 @property (nonatomic, assign) NSUInteger pages;
 @property (nonatomic, strong) JCAuthor *author;
 @end
 ...
 JCBook *book = [JCBook modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 ...
 ********************** Coding/Copying/hash/equal *********************
 @code
 @interface JCShadow :NSObject <NSCoding, NSCopying>
 @property (nonatomic, copy) NSString *name;
 @property (nonatomic, assign) CGSize size;
 @end
 
 @implementation JCShadow
 ...
 */
+ (nullable instancetype)jcui_modelWithJSON:(id)json;
...
/**
 ...
 `NSString` -> NSDate, parsed with format "JCJC-MM-dd'T'HH:mm:ssZ", "JCJC-MM-dd HH:mm:ss" or "JCJC-MM-dd".
 `NSString` -> NSURL.
 `NSValue` -> struct or union, such as CGRect, CGSize, ...
 `NSString` -> SEL, Class.
 */
+ (nullable instancetype)jcui_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (nullable id)jcui_modelToJSONObject;
 ...
 */
- (nullable NSData *)jcui_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)jcui_modelToJSONString;
 ...
 */
+ (nullable NSArray *)jcui_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
+ (nullable NSDictionary *)jcui_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<JCModel>' to your class header.
 */
 ...
 */
+ (nullable NSDictionary<NSString *, id> *)jcui_modelCustomPropertyMapper;
...
/**
 ...
 Example:
 @code
 @class JCShadow, JCBorder, JCAttachment;
 
 @interface JCAttributes
 @property NSString *name;
 ...
 @implementation JCAttributes
 + (NSDictionary *)modelContainerPropertyGenericClass {
 return @{@"shadows" : [JCShadow class],
 @"borders" : JCBorder.class,
 @"attachments" : @"JCAttachment" };
 }
 @end
 @endcode
 ...
 */
+ (nullable NSDictionary<NSString *, id> *)jcui_modelContainerPropertyGenericClass;
...
/**
 ...
 Example:
 @code
 @class JCCircle, JCRectangle, JCLine;
 
 @implementation JCShape
 ...
 */
+ (nullable Class)jcui_modelCustomClassForDictionary:(NSDictionary *)dictionary;
 ...
 */
+ (nullable NSArray<NSString *> *)jcui_modelPropertyBlacklist;
...
/**
 ...
 @return An array of property's name.
 */
+ (nullable NSArray<NSString *> *)jcui_modelPropertyWhitelist;
 ...
 */
- (NSDictionary *)jcui_modelCustomWillTransformFromDictionary:(NSDictionary *)dic;
 ...
 */
- (BOOL)jcui_modelCustomTransformFromDictionary:(NSDictionary *)dic;
...
/**
 ...
 @return Returns YES if the model is valid, or NO to ignore this model.
 */
- (BOOL)jcui_modelCustomTransformToDictionary:(NSMutableDictionary *)dic;
